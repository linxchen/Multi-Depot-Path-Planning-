...
set xrange [10:257]
set xtics 0,30,257
plot 'data4_0.txt' using 1:($2/1000000) title"12-Depot-Number" with linespoints ls 6 pt 6 pointsize 2.5,\
'data4_1.txt' using 1:($2/1000000) title"24-Depot-Number" with linespoints ls 7 pt 1 pointsize 2.5,\
