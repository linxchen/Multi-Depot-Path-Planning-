...
set xrange [0:18]
set xtics 0,2,18
plot 'data10_0.txt' using 1:2 title"INT-Path-Random" with linespoints ls 1 pt 12 pointsize 2.5,\
'data10_1.txt' using 1:2 title"INT-Path-Even" with linespoints ls 7 pt 2 pointsize 2.5,\
'data10_2.txt' using 1:2 title"INT-Path-Odd" with linespoints ls 3 pt 1 pointsize 2.5,\
