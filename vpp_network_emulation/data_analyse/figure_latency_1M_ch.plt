...
plot 'data_hop3_1M.txt' using ($3-1578018143.0):($4/1000.0) title"hop3" lc 7 pt 9 pointsize 1,\
 'data_hop2_1M.txt' using ($3-1578018143.0):($4/1000.0) title"hop2" lc 3 pt 5 pointsize 1


set terminal pngcairo size 1024,768 color solid linewidth 2.5 font "Microsoft YaHei,20"

set output "figure_latency_1M_ch.png"
