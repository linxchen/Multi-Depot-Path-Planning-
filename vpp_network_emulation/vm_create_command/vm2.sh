...
../vpp/build-root/install-vpp-native/external/share/dpdk/usertools/dpdk-devbind.py -b uio_pci_generic 0000:00:03.0 0000:00:08.0 0000:00:09.0 0000:00:10.0
...
# set interface ip address GigabitEthernet0/10/0 10.8.8.2/24

# ---vpp route---
# ---h2->h3---
# ip route add 10.3.3.0/24 via 10.8.8.1 GigabitEthernet0/10/0
